  ...
  try {
      ...
      void (async () => {
        try {
          ...
          const websiteResponse = await fetch(
            `https://90fd72f59232.ngrok-free.app/api/websites/get?id=${bgWebsiteId}`,
            {
              method: "GET",
              headers: {
                "Content-Type": "application/json",
    ...
    if (websiteCached) {
      void (async () => {
        try {
          const websiteResponse = await fetch(
            `https://90fd72f59232.ngrok-free.app/api/websites/get?id=${cacheKey}`,
            {
              method: "GET",
              headers: {
                "Content-Type": "application/json",
    ...
    const websiteResponse = await fetch(
      `https://90fd72f59232.ngrok-free.app/api/websites/get?id=${websiteId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
